...
- 🐛 **Countdowns No Longer Skip Calendar Days**: Timed events on consecutive dates could read "in 2 days" and "in 4 days." [Countdowns now follow local calendar dates](/features/event-content#countdown-display): localized "tomorrow" for the next date, exact days thereafter, and clock units only for starts later today. Distant dates stay in days rather than rounding into months or years. Existing countdown-enabled cards use this automatically, including all-day and split multi-day rows
