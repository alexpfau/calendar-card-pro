...
204 KB and the editor at 375 KB — once per version, then the browser caches both.
...
That brings the card to 62 KB and the editor to 102 KB, give or take a few hundred bytes
