...
249 KB and the editor at 450 KB — once per version, then the browser caches both.
...
That brings the card to 71 KB and the editor to 126 KB, give or take a few hundred bytes
