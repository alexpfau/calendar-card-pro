...
229 KB and the editor at 438 KB — once per version, then the browser caches both.
...
That brings the card to 67 KB and the editor to 122 KB, give or take a few hundred bytes
