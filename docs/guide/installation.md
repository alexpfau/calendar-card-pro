...
the card transfers at its full 286 KB and the editor at 503 KB — once per version, then the
browser caches both.
...
That brings the card to 81 KB and the editor to 145 KB at gzip level 9. These rounded
production-build figures were measured with Node 22.23.2's zlib at level 9; the exact sizes
