...
the card transfers at its full 252 KB and the editor at 495 KB — once per version, then the
browser caches both.
...
That brings the card to 73 KB and the editor to 142 KB at gzip level 9; the exact sizes
