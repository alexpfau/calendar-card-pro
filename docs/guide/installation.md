...
206 KB and the editor at 384 KB — once per version, then the browser caches both.
...
That brings the card to 62 KB and the editor to 103 KB, give or take a few hundred bytes
