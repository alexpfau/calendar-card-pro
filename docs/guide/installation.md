...
244 KB and the editor at 448 KB — once per version, then the browser caches both.
...
That brings the card to 70 KB and the editor to 128 KB, give or take a few hundred bytes
