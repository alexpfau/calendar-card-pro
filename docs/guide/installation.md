...
236 KB and the editor at 439 KB — once per version, then the browser caches both.
...
That brings the card to 68 KB and the editor to 123 KB, give or take a few hundred bytes
