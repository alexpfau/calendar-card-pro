...
203 KB and the editor at 368 KB — once per version, then the browser caches both.
...
That brings the card to 61 KB and the editor to 100 KB, give or take a few hundred bytes
