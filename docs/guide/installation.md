...
200 KB and the editor at 352 KB — once per version, then the browser caches both.
...
That brings the card to 60 KB and the editor to 95 KB, give or take a few hundred bytes
