...
the card transfers at its full 285 KB and the editor at 503 KB — once per version, then the
browser caches both.
...
That brings the card to 81 KB and the editor to 144 KB at gzip level 9. These rounded
