...
202 KB and the editor at 363 KB — once per version, then the browser caches both.
...
That brings the card to 60 KB and the editor to 99 KB, give or take a few hundred bytes
