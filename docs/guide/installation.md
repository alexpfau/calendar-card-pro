...
249 KB and the editor at 456 KB — once per version, then the browser caches both.
...
That brings the card to 71 KB and the editor to 131 KB, give or take a few hundred bytes
