...
245 KB and the editor at 455 KB — once per version, then the browser caches both.
...
That brings the card to 70 KB and the editor to 131 KB, give or take a few hundred bytes
