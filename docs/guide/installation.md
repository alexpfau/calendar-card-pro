...
the card transfers at its full 272 KB and the editor at 496 KB — once per version, then the
browser caches both.
...
That brings the card to 78 KB and the editor to 142 KB at gzip level 9. These rounded
