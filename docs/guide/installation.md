...
249 KB and the editor at 496 KB — once per version, then the browser caches both.
...
That brings the card to 72 KB and the editor to 142 KB at gzip level 9; the exact sizes
