...
204 KB and the editor at 372 KB — once per version, then the browser caches both.
...
That brings the card to 61 KB and the editor to 101 KB, give or take a few hundred bytes
