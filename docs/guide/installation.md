...
220 KB and the editor at 387 KB — once per version, then the browser caches both.
...
That brings the card to 66 KB and the editor to 104 KB, give or take a few hundred bytes
