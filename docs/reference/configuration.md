...
| `allday_badge`                  | boolean           | `false`                                            | Whether the all-day label is drawn as a rounded badge tinted with the calendar accent color, instead of plain text. Any end date that follows it stays as text                                        |
