...
| `progress_bar_width`            | string            | _per placement_                                    | Width of the progress bar. Unset, each layout uses its own: `60px` on the time row in list view, `75%` of the column in column view, where the bar takes a row of its own. A value here replaces both                                                                                        |
