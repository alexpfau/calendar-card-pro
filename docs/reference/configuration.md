...
| `min_day_column_width_px`      | number  | `152`                         | Narrowest a day column may become in column view before the card falls back to the list layout                                                                                                                                                                                                                                                                                                                                                      |
...
| Option                                | Type   | Default                | Description                                                                        |
| ------------------------------------- | ------ | ---------------------- | ---------------------------------------------------------------------------------- |
| `column → day_gap`                    | string | `8px`                  | Horizontal space between day columns, the column-view counterpart to `day_spacing` |
