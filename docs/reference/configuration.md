...
| `time_grid → allday_band_max_rows`       | number  | `3`                    | Rows the all-day band may grow to before remaining banners are dropped. Under a fixed height, the band scrolls to reserve at least half the content height for time |
