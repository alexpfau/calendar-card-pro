...
| On a later date       | The exact number of calendar days, such as "in 3 days"     |
...
Today's timed events stay in hours or minutes even when the wait is long enough that ordinary relative-time formatting would call it "a day." Later dates stay in calendar days too: an event 30 days away reads "in 30 days," not "in a month." The wording is localized to the card's language, and calendar-day counts remain correct across daylight-saving changes.
