...
- 🌍 **Weekends That Match Where You Live**: The card asked for Saturday and Sunday everywhere; it now [takes the weekend from your Home Assistant language](https://calendar-card-pro.alexpfau.com/features/core-settings#showing-a-calendar-on-weekdays-only), which is Friday and Saturday across the Arabic- and Hebrew-speaking world and Sunday alone across much of India. Weekend colors, the `days_of_week` filter and Grid's [weekend shading](https://calendar-card-pro.alexpfau.com/features/grid-view#shading-the-weekend) all agree now
