...
| `description_regex`                        | string            | -                                                  | A multiline regex pattern that is used on the description field. If it matches, the first matching group is displayed as summary compact mode. E.g., to show the second line of the description, use `.?*\n(.?*)\n`                                         |
| **Weather**                                |                   |                                                    |                                                                                                                                                                                                                                                             |
